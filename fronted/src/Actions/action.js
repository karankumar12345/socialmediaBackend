...
export const likeFailure = "like/likeFailure";
export const likeSuccess = "like/likeSuccess";
export const likeRequest = "like/likeRequest";
export const mypostFailure = "mypost/mypostFailure";
export const mypostSuccess = "mypost/mypostSuccess";
export const mypostRequest = "mypost/mypostRequest";

export const CREATE_POST_REQUEST = "createpost/CreatePostRequest";
export const CREATE_POST_SUCCESS = "createpost/CreatePostSuccess";
export const CREATE_POST_FAILURE = "createpost/CreatePostFailure";
export const COMMENT_REQUEST = "post/CommentRequest";
export const COMMENT_SUCCESS = "post/CommentSuccess";
export const COMMENT_FAILURE = "post/CommentFailure";
export const DELETE_COMMENT_REQUEST = "post/DeleteCommentRequest";
export const DELETE_COMMENT_SUCCESS = "post/DeleteCommentSuccess";
export const DELETE_COMMENT_FAILURE = "post/DeleteCommentFailure";
...
export const STORY_UPLOAD_FAILURE = "STORY_UPLOAD_FAILURE";
